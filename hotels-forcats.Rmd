...
First, knit the document and view the following visualization. How are the months ordered?  
  - Months are ordered based on arrival month in alpha order  
  What would be a better order?  
  - Jan-Dec  
 
  Then, reorder the months on the x-axis (levels of `arrival_date_month`) in a way that makes more sense. You will want to use a function from the **forcats** package, see https://forcats.tidyverse.org/reference/index.html for inspiration and help.
...
hotels %>%
  ...
  mutate(arrival_date_month = fct_relevel(arrival_date_month, "January", "Februray", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December")) %>% 
